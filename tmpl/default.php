...
print('<script language="javascript" type="text/javascript">var s5_randomorder = "'.$s5_randomorder.'";</script>');
print('<script language="javascript" type="text/javascript">var s5_hidecar = "'.$s5_hidecar.'";</script>');
print('<script language="javascript" type="text/javascript">var s5_hidebut = "'.$s5_hidebut.'";</script>');
print('<script language="javascript" type="text/javascript">var s5_hidetext = "'.$s5_hidetext.'";</script>');
print('<script language="javascript" type="text/javascript">var s5_hideh2 = "'.$s5_hideh2.'";</script>');
?>
...
if ($jslibrary == "mootools") {
	...
	$template_vertex = "yes";
		...
		print('<script language="javascript" type="text/javascript">var s5_dropdowntext = "'.$s5_dropdowntext.'";</script>');
		...
		<?php }
		if ($s5_thumbnailstretch == "true") { print('<style>.carouselInner .thumbnail {background-size: 100% 100% !important;;}</style>');	}
		if ($s5_hidefaderimages == "yes") { print('<style>.jdGallery .slideElement {background:none !important;}</style>'); }
		
		
		print('<script type="text/javascript">var s5_slide_opacity='.$s5_slide_opacity.'</script>');
		print('<script language="javascript" type="text/javascript">var s5_verticalhorizontal = "'.$s5_verticalhorizontal.'";</script>');
		
		print('<script src="'.$s5ic_url.'js/jd.gallery.jquery.js" type="text/javascript"></script>');
		print('<script src="'.$s5ic_url.'js/jd.gallery.transitions.jquery.js" type="text/javascript"></script>');
	?>
				<script type="text/javascript">//<![CDATA[
	...
	<?php			
		...
		if ($s5_thumbnailstretch == "true") { 
			print('<style>.carouselInner .thumbnail {background-size: 100% 100% !important;}</style>');
		}
		...
		print('<script src="'.$s5ic_url.'js/jd.gallery.js" type="text/javascript"></script>');
		print('<script src="'.$s5ic_url.'js/jd.gallery.transitions.js" type="text/javascript"></script>');
